...
def enabled_mcp_connections_list() -> List[Dict[str, Any]]:
  ...
  return [
    ...
    { "name": "aws-documentation-mcp-server", "url": "http://mcp-servers:8001/mcp", "host": "localhost:8001" },
    { "name": "aws-pricing-mcp-server", "url": "http://mcp-servers:8002/mcp", "host": "localhost:8002" },
    ...
    { "name": "aws-iac-mcp-server", "url": "http://mcp-servers:8005/mcp", "host": "localhost:8005" }
  ]
