...
* **Dockerized for Quick Setup**: With **Localstack** integration for offline AWS API simulation and simple **docker-compose** setup, a local application can be spun up in minutes.
